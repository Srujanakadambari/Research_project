...
baseline_score = scoring_function(DNN_model, X_test, y_test)

# Calculate permutation feature importance
result = permutation_importance(DNN_model, X_test, y_test, scoring=scoring_function)
...
# 19/19 [==============================] - 0s 684us/step
# 19/19 [==============================] - 0s 752us/step
# Feature Index: 2, Importance: 0.02799999999999998 s1 volt
# Feature Index: 3, Importance: 0.24666666666666667 s2 volt
# Feature Index: 1, Importance: 0.406 s2 amp
# Feature Index: 5, Importance: 0.307 temp
# Feature Index: 0, Importance: 0.012999999999999989  S1amp
# Feature Index: 4, Importance: 0.1503333333333333 light
# Feature Index: 6, Importance: 0.0 weather
# 
